// itch_parser_32bit generated with pyhdlweaver by Jakob Gross
// https://github.com/jakobgross/pyhdlweaver

module itch_parser_32bit #(
        ...
        if (parse_fire) begin
          case (beat_count)
            ...
            1: begin
              ...
              timestamp_reg[47:40] <= s_axis_tdata[15:8];
              timestamp_reg[39:32] <= s_axis_tdata[23:16];
              timestamp_reg[31:24] <= s_axis_tdata[31:24];
            end
            2: begin
