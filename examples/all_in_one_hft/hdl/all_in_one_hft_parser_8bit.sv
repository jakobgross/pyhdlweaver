// all_in_one_hft_parser_8bit generated with pyhdlweaver by Jakob Gross
// https://github.com/jakobgross/pyhdlweaver

module all_in_one_hft_parser_8bit #(
...
always_comb begin
  ...
  if (parse_fire && beat_count == PARSE_FINAL_BEAT) begin
    mold_msg_count_comb[7:0] = s_axis_tdata[7:0];
  end
end
      ...
      ST_PARSE: begin
        ...
        if (parse_fire) begin
          ...
          case (beat_count)
            ...
            36: begin
              udp_dst_port_reg[15:8] <= s_axis_tdata[7:0];
            end
            37: begin
              udp_dst_port_reg[7:0] <= s_axis_tdata[7:0];
            end
            42: begin
              mold_session_id_reg[79:72] <= s_axis_tdata[7:0];
            end
            43: begin
              mold_session_id_reg[71:64] <= s_axis_tdata[7:0];
            end
            44: begin
              mold_session_id_reg[63:56] <= s_axis_tdata[7:0];
            end
            45: begin
              mold_session_id_reg[55:48] <= s_axis_tdata[7:0];
            end
            46: begin
              mold_session_id_reg[47:40] <= s_axis_tdata[7:0];
            end
            47: begin
              mold_session_id_reg[39:32] <= s_axis_tdata[7:0];
            end
            48: begin
              mold_session_id_reg[31:24] <= s_axis_tdata[7:0];
            end
            49: begin
              mold_session_id_reg[23:16] <= s_axis_tdata[7:0];
            end
            50: begin
              mold_session_id_reg[15:8] <= s_axis_tdata[7:0];
            end
            51: begin
              mold_session_id_reg[7:0] <= s_axis_tdata[7:0];
            end
            52: begin
              mold_seq_num_reg[63:56] <= s_axis_tdata[7:0];
            end
            53: begin
              mold_seq_num_reg[55:48] <= s_axis_tdata[7:0];
            end
            54: begin
              mold_seq_num_reg[47:40] <= s_axis_tdata[7:0];
            end
            55: begin
              mold_seq_num_reg[39:32] <= s_axis_tdata[7:0];
            end
            56: begin
              mold_seq_num_reg[31:24] <= s_axis_tdata[7:0];
            end
            57: begin
              mold_seq_num_reg[23:16] <= s_axis_tdata[7:0];
            end
            58: begin
              mold_seq_num_reg[15:8] <= s_axis_tdata[7:0];
            end
            59: begin
              mold_seq_num_reg[7:0] <= s_axis_tdata[7:0];
            end
            60: begin
              mold_msg_count_reg[15:8] <= s_axis_tdata[7:0];
            end
            61: begin
              mold_msg_count_reg[7:0] <= s_axis_tdata[7:0];
            end
            default: ;
          endcase
