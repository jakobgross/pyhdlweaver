// udp_port_router_64bit generated with pyhdlweaver by Jakob Gross
// https://github.com/jakobgross/pyhdlweaver

module udp_port_router_64bit #(
        ...
        if (parse_fire) begin
          case (beat_count)
            4: begin
              ...
              udp_length_reg[15:8] <= s_axis_tdata[55:48];
              udp_length_reg[7:0] <= s_axis_tdata[63:56];
            end
            5: begin
