// mold_udp_80bit generated with pyhdlweaver by Jakob Gross
// https://github.com/jakobgross/pyhdlweaver

module mold_udp_80bit #(
...
always_comb begin
  ...
  if (parse_fire && beat_count == PARSE_FINAL_BEAT) begin
    ...
    seq_num_comb[39:32] = s_axis_tdata[31:24];
    seq_num_comb[31:24] = s_axis_tdata[39:32];
    seq_num_comb[23:16] = s_axis_tdata[47:40];
    seq_num_comb[15:8] = s_axis_tdata[55:48];
    seq_num_comb[7:0] = s_axis_tdata[63:56];
  end
end
        ...
        if (parse_fire) begin
          ...
          case (beat_count)
            ...
            1: begin
              ...
              seq_num_reg[55:48] <= s_axis_tdata[15:8];
              seq_num_reg[47:40] <= s_axis_tdata[23:16];
              seq_num_reg[39:32] <= s_axis_tdata[31:24];
              seq_num_reg[31:24] <= s_axis_tdata[39:32];
              seq_num_reg[23:16] <= s_axis_tdata[47:40];
              seq_num_reg[15:8] <= s_axis_tdata[55:48];
              seq_num_reg[7:0] <= s_axis_tdata[63:56];
              msg_count_reg[15:8] <= s_axis_tdata[71:64];
              msg_count_reg[7:0] <= s_axis_tdata[79:72];
            end
            default: ;
          endcase
